...
#1. User should set execution Policy before beginning. With powershell in admin mode run the following: Set-ExecutionPolicy -ExecutionPolicy Unrestricted 

#2. User should run app to test in Android Studio to ensure correct versioning established for adb usage.
#-----------------------------------------------------------------------------
